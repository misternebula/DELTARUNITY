...
pushi.e 6
pop.v.s [array]self.itemtype
push.s "obj_shop2_slash_Create_0_gml_73_0"@9398
conv.s.v
call.i scr_84_get_lang_string(argc=1)
pushi.e -1
pushi.e 0
pop.v.v [array]self.shopdesc
push.s "obj_shop2_slash_Create_0_gml_74_0"@9399
conv.s.v
call.i scr_84_get_lang_string(argc=1)
pushi.e -1
pushi.e 1
pop.v.v [array]self.shopdesc
push.s "obj_shop2_slash_Create_0_gml_75_0"@9400
conv.s.v
call.i scr_84_get_lang_string(argc=1)
pushi.e -1
pushi.e 2
pop.v.v [array]self.shopdesc
push.s "obj_shop2_slash_Create_0_gml_76_0"@9401
conv.s.v
call.i scr_84_get_lang_string(argc=1)
pushi.e -1
pushi.e 3
